  ...
  return (
    <div className="mx-4">
      <div className="flex items-center justify-between py-3">
        <div
          className="flex cursor-pointer items-center rounded-lg bg-slate-100 p-3 text-sm transition duration-300 ease-in-out hover:bg-slate-100 dark:bg-slate-800/50 dark:hover:bg-slate-700/80"
